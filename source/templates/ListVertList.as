...
package {
	...
	public class ListVertList extends ListTemplate {

		private var ImageAssets			:Array;
		
		public function ListVertList():void {
			super();
		...
		override protected function renderItems():void {
			...
			*/
			...
			if (!listX) listX = _PageRenderer.pageBorderLeft;
			...
			for (var i:int = 0; i < len; i++ ) {
				...
				c.hi_mc.scaleY = (10+c.text_txt.height) * .01;
				...
				if (_Animate) {
					c.alpha = 0;
					c.y -= 50;
					TweenLite.to(c, 1, { alpha:1, y:cY, delay:(i*.5), ease:Quadratic.easeOut, onComplete:enableItem, onCompleteParams:[_CurrentList, i] } );
				} else {
