...
// modified to support Sprites natively from MovieClips
...
package com.pixelfumes.reflect{
	...
	public class ReflectSpr extends Sprite{
		...
		function ReflectSpr(args:Object){
			...
			var mcHeight = mc.height+1;
			var mcWidth = mc.width+1;
			...
			var gradientMaskRef:DisplayObject = mc.addChild(new Sprite());
			gradientMaskRef.name = "gradientMask_mc";
			
			//get a reference to the movie clip - cast the DisplayObject that is returned as a Sprite
			gradientMask_mc = mc.getChildByName("gradientMask_mc") as Sprite;
